"""Warmed GMaster GPU versus NaMaster CPU flat-workspace benchmark."""
...
def run(size):
    ...
    workspace = gmaster.NmtWorkspaceFlat(field, field, bins)
    workspace.mcm_binned.block_until_ready()
    ...
    start = time.perf_counter()
    reference.NmtWorkspaceFlat(reference_field, reference_field, reference_bins)
